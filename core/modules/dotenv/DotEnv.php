...
require_once ('Processor\AbstractProcessor.php');
require_once ('Processor\BooleanProcessor.php');
require_once ('Processor\QuotedProcessor.php');
...
class DotEnv
{
    ...
    {
		$file = $path;
		$fileLocal = $path . '.local';
		
		// Try if .env.local exist before checking if .env exist
