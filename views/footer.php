<footer class="py-3 my-4 border-top">
	<div class="container">
		...
		<div class="d-flex flex-wrap justify-content-between pt-4 mt-4 align-items-center border-top">
			...
			<ul class="list-unstyled d-flex">
				<li class="ms-3">
					<a class="link-light" href="https://twitter.com/BFourmaux">
						<i class="fa-brands fa-twitter"></i>
					</a>
				</li>
				<li class="ms-3">
					<a class="link-light" href="https://github.com/users/BenjaminFourmaux/projects/1">
